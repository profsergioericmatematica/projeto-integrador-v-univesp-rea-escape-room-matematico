...
const diagnosticosErro = {
    ...
    'f1_cabo2': {
        ...
        '400': 'Você elevou apenas o 20 ao quadrado (400) e esqueceu de somar o quadrado do cateto vertical (4² = 16).'
    },
    'f1_fora416': {
    ...
    'f2_hip': {
        '225': '225 é a "área" total (a²+b²), não a hipotenusa. Falta extrair a raiz quadrada: √225 = 15.',
    ...
    'ni1': {
        '55': 'Para dízimas, o numerador deve ter apenas o período simples (o dígito que se repete: 5), não 55.',
    ...
    'areaMarceneiro': {
        '54': '54 é o numerador antes de simplificar (9×6). Falta dividir pelo denominador (9) para chegar à área final: 6.',
    ...
    'f4_n_num': {
        '4': 'Você inverteu a fração para (3/2)², mas o numerador correto é 3² = 9, não 4.',
        '2': 'Você inverteu, mas esqueceu de elevar o 3 ao quadrado.',
        '6': '3² significa 3×3 = 9, não 3×2 = 6.'
    },
    'f4_n_den': {
        '9': 'Você inverteu corretamente a base, mas trocou numerador com denominador: em (3/2)², o denominador é 2² = 4, não 9.',
    ...
    // =============================================
    'raiz_baixa': {
        '169': '169 é a área (o quadrado do lado), não o lado. Qual número multiplicado por ele mesmo resulta em 169?',
        '14': '14x14 passa de 169.'
    },
    'raiz_alta': {
        '196': '196 é a área, não o lado. Falta extrair a raiz quadrada exata de 196.',
        '15': '15 é 225. Procure um pouco antes.'
    },
    'raiz180_fora': {
        '36': '36 é o quadrado de 6 (6²). O fator que sai da raiz é o 6, não o 36.',
    ...
    'reta_frac1': {
        ...
        'P': 'Divida 25 por 99 na calculadora: o resultado (≈0,25) está próximo de 0, então a posição correta na reta é O, não P.'
    },
    'reta_frac2': {
        'M': '193/90 é um pouco mais que 2.',
        'O': '193/90 ≈ 2,14 (pouco mais que o dobro de 90), portanto fica próximo de 2 — a posição correta é P, não O.'
    },
    'raiz180_aprox': {
    ...
    'f6_total': {
        '48': 'O cubo tem 12 arestas no total (não 6 faces ou quinas). Reveja quantas arestas estruturais faltam contar.',
    ...
    'fita_raiz': {
        '2.25': 'Você dividiu 9 por 4 direto (=2,25), mas é preciso extrair a raiz de cada um: √9/√4 = 3/2 = 1,5.',
    ...
    'fita_sobra': {
        ...
        '9.5': 'A soma correta dos três retalhos (2,5 + 0,75 + 1,5) é 4,75m. Subtraindo do rolo de 12m, a sobra é 7,25m — reveja sua soma.'
    },
    ...
    'f7_minutos': {
        ...
        '206': 'Você subtraiu os 10 minutos da pausa em vez de somar. O tempo total de laboratório é a soma de tudo, não a subtração.',
    ...
    'f7_horas': {
        '2': 'Em 226 minutos cabem mais que 2 horas: 2h = 120 min, e ainda sobram 106 min — mais do que 1 hora inteira.',
        '4': '4 horas seriam 240 minutos (já passou do tempo do filme).'
    },
    'f7_minResto': {
        '26': '3 horas são 180 minutos. 226 − 180 = 46 minutos avulsos, não 26 — reveja a subtração.',
        '60': 'Os restos nunca podem chegar a 60, senão viram outra hora.'
    },
    'f7_horario': {
        '24h56': 'Quando bate 24h, o ciclo do dia zera para 00h.',
        '25h56': 'O relógio não passa de 24h: ao bater meia-noite, a contagem zera de volta para 00h, então não existe "25h".'
    },
    ...
    // =============================================
    'f8_resposta': {
        '34': 'Você somou termos que ainda não estavam na sequência (13+21=34). Olhe os dois últimos números mostrados (8 e 13): a soma deles é 21, esse é o próximo termo.',
        '14': 'A sequência não aumenta de 1 em 1.'
    },
    'f8_phi': {
        '161': 'Faltou o ponto/vírgula decimal: φ é um número menor que 2 (aproximadamente 1,61), não 161.',
